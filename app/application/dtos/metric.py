"""Application DTOs related to hourly metric queries."""
...
class HourlyMetricQueryFiltersDTO(BaseModel):
    """Query filters for retrieving hourly metrics."""

    start_time: datetime | None = None
    end_time: datetime | None = None
    pagination: PaginationDTO = Field(default_factory=PaginationDTO)
    sort: SortDTO = Field(default_factory=lambda: SortDTO(field="window_start", direction="desc"))
